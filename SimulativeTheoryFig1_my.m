%[1] "Domain Adaptation for DoA Estimation in Multipath Channels with Interferences", A. Bar, J. S. Picard, I. Cohen and R. Talmon
...
for ii=0:1
    ...
    a_I2        = IsTwoInterferences*exp(2j*pi*Array'/2*cos(Theta_I2/180*pi));  % (7) of [1]
    K = 100;
    for k=1:K
